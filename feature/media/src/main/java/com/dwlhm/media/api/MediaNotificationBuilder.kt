 ...
 * @param mainActivityClass Class untuk MainActivity (untuk content intent)
 * @param smallIconResId Resource ID untuk small icon
 */
class MediaNotificationBuilder(
    ...
    fun createNotificationChannel() {
        val channel = NotificationChannel(
            CHANNEL_ID,
            "Media Playback",
            NotificationManager.IMPORTANCE_MIN  // Minimal - hanya icon di status bar, tidak muncul di drawer
        ).apply {
